...
public class Track implements Serializable{
	...
	public String toString() {
		return "Track [recode_id=" + recode_id + ", recode_title="
				+ recode_title + ", recode_content=" + recode_content
				+ ", recode_time=" + recode_time + ", recode_ntime="
				+ recode_ntime+ ", dictionory="
				+ dictionory.getId()+","+dictionory.getContext()  + "]";
	}
