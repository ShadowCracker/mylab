...
<div class="navbar navbar-default" id="navbar">
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="bootm.jsp" class="navbar-brand"> <small> <i
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <span
							class="user-info"> <small>欢迎光临,${userInfor.number}</small>
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a
						href="bootm.jsp" target="mainframe">
							<i class="icon-dashboard"></i> <span class="menu-text">
								控制台 </span>
					</a></li>
                    
            <c:forEach items="${map }" var="mykey">
               <li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> ${mykey.key.name } </span> <b class="arrow icon-angle-down"></b>
					</a>
						<ul class="submenu">
						 <c:forEach items="${mykey.value }" var="anth">
								<li><a href="${anth.url }" target="mainframe"> <i
									class="icon-double-angle-right"></i> ${anth.name}
							</a></li>
							</c:forEach> 
						</ul>
				</li>     
			...
			<!-- 注释bootm.jsp -->
			  <div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="bootm.jsp"
