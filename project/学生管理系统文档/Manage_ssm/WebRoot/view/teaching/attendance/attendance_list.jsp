...
<div class="row" style="padding:15px; padding-top:0px; ">
    ...
    <ds:table name="${attendanceList}" pagesize="6" export="true" class="table  table-condensed table-striped">
    	...
    	<ds:column title="操作" href="attend.do?findById&id" paramId="id" paramProperty="aid">修改</ds:column>
    	<ds:column title="操作" href="attend.do?delete&id" paramId="id" paramProperty="aid">删除</ds:column>
