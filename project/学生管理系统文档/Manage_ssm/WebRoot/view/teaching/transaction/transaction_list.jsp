...
<div class="row" style="padding:15px; padding-top:0px; ">
        ...
        <ds:table name="${transactionList}" pagesize="10" export="true" class="table  table-condensed table-striped">
        ...
        <ds:column title="操作"  href="trans.do?findById&id" paramId="id" paramProperty="tid">修改</ds:column>
        <ds:column title="操作"  href="trans.do?delete&id"  paramId="id" paramProperty="tid">删除</ds:column>
