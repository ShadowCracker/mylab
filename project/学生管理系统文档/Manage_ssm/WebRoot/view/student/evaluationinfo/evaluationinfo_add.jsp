...
<form action="evaluation.do?save" method="post" class="form-horizontal">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="id" readonly="readonly" class="form-control input-sm" placeholder="请输入评价编号"/>
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="title" class="form-control input-sm" placeholder="请输入主题"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text" name="course" class="form-control input-sm" placeholder="请输入课程名称"/>
                </div>
            </div>
        </div>
    	<div class="col-sm-5">
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="date" name="etime" class="form-control input-sm" placeholder="请输入评价时间"/>
                </div>
            </div>
        </div>
		<div class="col-sm-5">
