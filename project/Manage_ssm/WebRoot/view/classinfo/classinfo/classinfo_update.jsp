    ...
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                		<% %>
               			<input type="date" name="start" value="<fmt:formatDate value='${classesList.start}' pattern='yyyy-MM-dd' />" readonly="readonly" class="form-control input-sm" placeholder="请输入开班日期"/>
                </div>
            </div>
        </div>
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               		 <input type="date" name="end" value="<fmt:formatDate value='${classesList.end}' pattern='yyyy-MM-dd' />" class="form-control input-sm" placeholder="请输入结束日期"/>
                </div>
            </div>
