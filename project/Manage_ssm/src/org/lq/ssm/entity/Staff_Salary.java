...
public class Staff_Salary implements Serializable{
	...
	public String toString() {
		return "Staff_Salary [ssid=" + ssid + ", 领取人staid=" + staid.getSid() + ", stasid="
				+ stasid.getSid() + ", totsal=" + totsal + ", desal=" + desal
				+ ", resal=" + resal + ", isused=" + isused + ", saldate="
				+ saldate + ", remark=" + remark + "]";
	}
