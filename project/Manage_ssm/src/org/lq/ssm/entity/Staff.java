    ...
    */
	...
	public String toString() {
		return "Staff [sid=" + sid + ", name=" + name + ", sex=" + sex
				+ ", age=" + age + ", place=" + place + ", idcard=" + idcard
				+ ", birthday=" + birthday + ", office=" + office + ", phone="
				+ phone + ", email=" + email + ", address=" + address + ", qq="
				+ qq + ", hiredate=" + hiredate + ", edulevel=" + edulevel
				+ ", desc=" + desc + ", state=" + state + ", password="
