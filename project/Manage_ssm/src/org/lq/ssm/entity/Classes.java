...
public class Classes implements Serializable{
	...
	public String toString() {
		return "Classes [id=" + id + ", name=" + name + ", num=" + num
				+ ", start=" + start + ", end=" + end + ", isused=" + isused
				+ ", state=" + state + ", desc=" + desc + ", classRoom="
				+ classRoom.getId() + ", subject=" + subject.getId() + ", schedule=" + schedule.getId()
				+ ", staff=" + staff.getSid() + "]";
	}
